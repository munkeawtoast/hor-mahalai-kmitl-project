...
export function generateUsers(from = 0, to = 1) {
  ...
  for (let index = 0; index < count; index++) {
    ...
    const userImage = faker.image.people(undefined, undefined, true)
    users.push({
      id,
      firstName,
      lastName,
...
const sereializedUsers = JSON.stringify(generateUsers(0, 15), null, 2)
fs.writeFileSync('./users.json', sereializedUsers)
